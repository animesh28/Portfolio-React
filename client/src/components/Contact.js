...
function Contact() {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      fName: Yup.string().required("Sorry, First Name is required"),

      lName: Yup.string().required("Sorry, Last Name is required"),
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        checkedIcon={
                          <BookmarkIcon style={{ fill: "rgb(126,83,249)" }} />
                        }
                      />
                    }
...
const ContactCTA = styled.div`
  ...
  span.blue-bubble {
    ...
    height: 150px;
    border-radius: 50%;
    background-color: rgba(126, 83, 249, 0.8);
    position: absolute;
    bottom: 10vh;
    right: 5vw;
    z-index: 2;
